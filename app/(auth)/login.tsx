...
export default function LoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      Alert.alert("Connection Error", "Cannot connect to the server. Please check your IP address.");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* 🌟 Keyboard එක එද්දී UI එක හැඩගැහෙන්න මේක දානවා 🌟 */}
      <KeyboardAvoidingView 
        style={{ flex: 1 }} 
...
const styles = StyleSheet.create({
  ...
  content: { paddingHorizontal: 30, paddingVertical: 20 },
  ...
  forgotPasswordText: { color: '#1976D2', textAlign: 'center', fontWeight: '600', marginTop: 5, marginBottom: 10 },
  ...
  footerText: { marginTop: 40, color: '#94A3B8', fontSize: 12, fontStyle: 'italic', textAlign: 'center' },
});